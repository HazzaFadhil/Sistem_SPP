...
if(isset($_POST['username'])) {
	...
	if(mysqli_num_rows($cek_siswa) > 0) {
		...
		echo '<script>alert("selamat, anda berhasil login");location.href="index.php";</script>';
			...
			echo '<script>alert("waduh, salah username/password");</script>';
		}
	}
}
...
<head>
	...
	<title>Sign In | Aplikasi SPP</title>
							...
							<div class="card-body">
								<div class="m-sm-3">
									<form method="post">
										...
										<input class="form-control form-control-lg" type="password" name="password" placeholder="Masukan passwrod" />
                                        </div>
										<div class="text-center mt-3">
											<button href="submit" class="btn btn-lg btn-primary">Sign in</a>
										</div>
									</form>
								</div>
							</div>
