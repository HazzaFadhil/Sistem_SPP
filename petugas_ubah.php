...
if(isset($_POST['nama_petugas'])){
    ...
    $query = mysqli_query($koneksi, "UPDATE petugas SET nama_petugas='$nama_petugas', 
    username='$username', level='$level' WHERE id_petugas=$id"); 
    ...
    if($query) {
        echo '<script>alert("Ubah Data Petugas Berhasil")</script>';
    }else{
        echo '<script>alert("Ubah Data Petugas Gagal")</script>';
    }
}
                ...
                <form method="post">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td width="1">:</td>
                            <td><input class="form-control" value="<?php echo $data['password']; ?>" type="number" 
                            name="password">
                            *) jika tidak diubah, kosongkan saja.
                        </td>
                        </tr>
                        <tr>
