...
if(isset($_POST['tahun'])){
    ...
    $query = mysqli_query($koneksi, "UPDATE spp SET tahun='$tahun', 
                ...
                <form method="post">
                    <table class="table">
                        <tr>
                            ...
                            <td width="1">:</td>
                            <td><input class="form-control" value="<?php echo $data['tahun']; ?>" type="number" 
                            name="tahun"></td>
                        </tr>
                        <tr>
                            <td width="200">Nominal</td>
                            <td width="1">:</td>
                            <td><input class="form-control" value="<?php echo $data['nominal']; ?>" type="number" 
                            name="nominal"></td>
                        </tr>
                        <tr>
                            <td></td>
